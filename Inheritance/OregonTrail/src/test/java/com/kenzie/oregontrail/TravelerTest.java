...
public class TravelerTest {
    ...
    @Order(9)
    @Test
    void travelerClass_GettersandSetters_Exist() {
        try {
            ...
            assertTrue(false, "Please double check your Traveler Class has the correct Constructors and that your class also has getters and setters for getName, setName, getFood, setFood, getIsHealthy and setIsHealthy.");
        }
    }
