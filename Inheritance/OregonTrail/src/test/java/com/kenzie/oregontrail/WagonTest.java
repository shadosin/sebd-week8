...
public class WagonTest {
    ...
    void canTravelerJoin() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
            ...
            assertEquals(2, t.size(), "there should only be " + capacity + " people in the wagon");
            assertEquals("Jane", t0Name, "Jane should be first in the wagon");
            assertEquals("Kevin", t1Name, "Kevin should be second on the wagon");
    }
